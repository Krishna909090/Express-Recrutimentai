...
const ENCRYPTION_KEY = ENCRYPTION_UTF8.parse(process.env.ENCRYPTION_CONFIG_KEY);
const ENCRYPTION_IV = ENCRYPTION_UTF8.parse(process.env.ENCRYPTION_CONFIG_IV);
